    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: 'var(--light-background)' }}>
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 mx-auto mb-4" style={{ borderColor: 'var(--primary-green)' }}></div>
        ...
        <div className="modern-card">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
            <div>
              ...
              <p className="text-sm text-gray-500">Manage and monitor your blog performance</p>
            </div>
            <Link to="/create-blog">
              <Button size="sm" style={{ backgroundColor: 'var(--primary-green)', color: 'var(--utility-white)'}}>
                <Plus className="h-4 w-4 mr-2" />
                New Blog
              </Button>
            </Link>
