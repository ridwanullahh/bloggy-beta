...
const Index: React.FC = () => {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--light-background)' }}>
      ...
      <section className="relative pt-24 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center">
            ...
            {/* Main Headline */}
            <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight" style={{ color: 'var(--brand-dark)'}}>
              Build Your
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <Link to="/auth">
                <Button size="lg" className="w-full sm:w-auto px-8 py-4 text-lg shadow-xl hover:shadow-2xl transition-all duration-300" style={{ backgroundColor: 'var(--primary-green)', color: 'var(--utility-white)'}}>
              ...
              {platformStats.map((stat, index) => (
                <div key={index} className="text-center">
                  <div className="flex items-center justify-center mb-2">
                    <div className="p-2 rounded-lg" style={{ backgroundColor: 'var(--utility-white)'}}>
                      {stat.icon}
                    </div>
                  </div>
                  <div className="text-2xl md:text-3xl font-bold" style={{ color: 'var(--brand-dark)'}}>{stat.number}</div>
      ...
      <section id="features" className="py-24 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: 'var(--utility-white)'}}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <Badge className="mb-4" style={{ backgroundColor: 'var(--light-background)', color: 'var(--primary-green)'}}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
                ...
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold mb-2" style={{ color: 'var(--brand-dark)'}}>{feature.title}</h3>
            ...
            <div className="relative">
              <div className="rounded-3xl shadow-2xl p-8 border" style={{ backgroundColor: 'var(--utility-white)'}}>
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="h-4 rounded w-3/4" style={{ backgroundColor: 'var(--primary-green)'}}></div>
                    <div className="h-3 bg-gray-200 rounded w-full"></div>
                    <div className="h-3 bg-gray-200 rounded w-5/6"></div>

                    <div className="grid grid-cols-2 gap-4 mt-6">
                      <div className="h-20 rounded-lg" style={{ backgroundColor: 'var(--light-background)'}}></div>
                      <div className="h-20 rounded-lg" style={{ backgroundColor: 'var(--light-background)'}}></div>
                    </div>

                    <div className="flex space-x-2 mt-4">
                      <div className="h-8 rounded px-4 flex items-center" style={{ backgroundColor: 'var(--primary-green)'}}>
              ...
              {/* Floating Elements */}
              <div className="absolute -top-4 -right-4 w-16 h-16 rounded-full flex items-center justify-center shadow-lg" style={{ backgroundColor: 'var(--accent-gold)'}}>
                <Heart className="h-6 w-6 text-white" />
              </div>
              <div className="absolute -bottom-4 -left-4 w-16 h-16 rounded-full flex items-center justify-center shadow-lg" style={{ backgroundColor: 'var(--primary-green)'}}>
      ...
      <section id="pricing" className="py-24 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: 'var(--utility-white)'}}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <Badge className="mb-4" style={{ backgroundColor: 'var(--light-background)', color: 'var(--primary-green)'}}>
                ...
                <div className={`text-center ${plan.popular ? 'pt-12' : 'pt-8'}`}>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-baseline justify-center">
                      <span className="text-5xl font-bold" style={{ color: 'var(--brand-dark)'}}>{plan.price}</span>
      ...
      {/* Modern CTA Section */}
      <section className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden" style={{ backgroundColor: 'var(--primary-green)'}}>
        {/* Background Elements */}
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link to="/auth">
              <Button size="lg" className="w-full sm:w-auto px-8 py-4 text-lg font-semibold shadow-xl" style={{ backgroundColor: 'var(--utility-white)', color: 'var(--primary-green)'}}>
                <Rocket className="mr-2 h-5 w-5" />
                Start Free Trial
              </Button>
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <span className="font-bold text-2xl text-white">Bloggy</span>
